...
namespace Cocoa::Stubs
{
	...
	public:
		...
		Unique<Graphics::VertexBuffer> CreateVertexBuffer(uint32_t size, const Graphics::BufferLayout& bufferLayout) override;
		Unique<Graphics::VertexBuffer> CreateVertexBuffer(const void* vertices, uint32_t size, const Graphics::BufferLayout& bufferLayout) override;
